...
public class AllDocumentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllDocumentAdapter(Context context2, ArrayList<DocumentModel> arrayList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.ivUncheck.setImageDrawable(AllDocumentAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_unseleted));
            this.ivCheck.setImageDrawable(AllDocumentAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_selected));
            this.iv_fav_image.setImageDrawable(AllDocumentAdapter.this.context.getResources().getDrawable(R.drawable.ic_fav_fill));
        ...
        public void onClick(View view) {
            AllDocumentAdapter.listener.onItemClick(getAdapterPosition(), view);
        }

        public boolean onLongClick(View view) {
            AllDocumentAdapter.longClickListener.onItemLongClick(getAdapterPosition(), view);
            return true;
        }
    }
