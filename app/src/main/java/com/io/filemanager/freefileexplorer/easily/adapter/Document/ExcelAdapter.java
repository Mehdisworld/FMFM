...
public class ExcelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExcelAdapter(Context context2, ArrayList<DocumentModel> arrayList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.ivUncheck.setImageDrawable(ExcelAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_unseleted));
            this.ivCheck.setImageDrawable(ExcelAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_selected));
            this.iv_fav_image.setImageDrawable(ExcelAdapter.this.context.getResources().getDrawable(R.drawable.ic_fav_fill));
        ...
        public void onClick(View view) {
            ExcelAdapter.listener.onItemClick(getAdapterPosition(), view);
        }

        public boolean onLongClick(View view) {
            ExcelAdapter.longClickListener.onItemLongClick(getAdapterPosition(), view);
            return true;
        }
    }
