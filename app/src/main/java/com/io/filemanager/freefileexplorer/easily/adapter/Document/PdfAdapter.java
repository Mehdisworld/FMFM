...
public class PdfAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PdfAdapter(Context context2, ArrayList<DocumentModel> arrayList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.ivUncheck.setImageDrawable(PdfAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_unseleted));
            this.ivCheck.setImageDrawable(PdfAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_selected));
            this.iv_fav_image.setImageDrawable(PdfAdapter.this.context.getResources().getDrawable(R.drawable.ic_fav_fill));
