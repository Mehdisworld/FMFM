...
public class PptAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PptAdapter(Context context2, ArrayList<DocumentModel> arrayList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.ivUncheck.setImageDrawable(PptAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_unseleted));
            this.ivCheck.setImageDrawable(PptAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_selected));
            this.iv_fav_image.setImageDrawable(PptAdapter.this.context.getResources().getDrawable(R.drawable.ic_fav_fill));
        ...
        public void onClick(View view) {
            PptAdapter.listener.onItemClick(getAdapterPosition(), view);
        }

        public boolean onLongClick(View view) {
            PptAdapter.longClickListener.onItemLongClick(getAdapterPosition(), view);
            return true;
        }
    }
