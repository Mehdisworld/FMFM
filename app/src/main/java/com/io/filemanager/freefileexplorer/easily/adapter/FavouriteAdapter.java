...
public class FavouriteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FavouriteAdapter(Context context2, ArrayList<InternalStorageFilesModel> arrayList, boolean z) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.ivUncheck.setImageDrawable(FavouriteAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_unseleted));
            this.ivCheck.setImageDrawable(FavouriteAdapter.this.context.getResources().getDrawable(R.drawable.ic_radio_btn_selected));
            this.iv_fav_image.setImageDrawable(FavouriteAdapter.this.context.getResources().getDrawable(R.drawable.ic_fav_fill));
