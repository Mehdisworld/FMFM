...
public class FavouriteHeaderListAdapter extends RecyclerView.Adapter<FavouriteHeaderListAdapter.ViewHolder> {
    ...
    public FavouriteHeaderListAdapter(Context context2, ArrayList<String> arrayList) {
        ...
        if (i != 0) {
            ...
            viewHolder.txt_app_name.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    FavouriteHeaderListAdapter.listener.onItemHeaderClick(i, view);
                }
            });
            viewHolder.txt_app_name.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    FavouriteHeaderListAdapter.listener.onItemHomeClick(i, view);
                }
            });
        } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            FavouriteHeaderListAdapter.listener.onItemClick(getAdapterPosition(), view);
        }
    }
}
